...
<LI><A HREF="Input.jsp?method=11&methodName=createAccount" TARGET="inputs">createAccount(java.lang.String,double)</A></LI>
<LI><A HREF="Input.jsp?method=18&methodName=withdraw" TARGET="inputs">withdraw(long,java.lang.Double)</A></LI>
<LI><A HREF="Input.jsp?method=31&methodName=getAccountInfo" TARGET="inputs">getAccountInfo(long)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleAccountsPortProxyid.getClass())) {
%>
