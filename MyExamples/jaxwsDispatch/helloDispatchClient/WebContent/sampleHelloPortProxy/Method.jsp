...
<LI><A HREF="Input.jsp?method=11&methodName=hello" TARGET="inputs">hello(java.lang.String)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleHelloPortProxyid.getClass())) {
%>
