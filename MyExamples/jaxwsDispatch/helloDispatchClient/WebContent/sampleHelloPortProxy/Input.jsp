...
<TR>
<TD ALIGN="left" CLASS="nullcol"><input type="checkbox" name="message14null" value="message14null"></TD>
<TD COLSPAN="1" ALIGN="LEFT" CLASS="headingcol">message:</TD>
<TD ALIGN="left"><INPUT TYPE="TEXT" NAME="message14" SIZE=20></TD>
</TR>
</TABLE>
<% } %>
<BR/>
