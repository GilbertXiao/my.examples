...
URL wsdlURL = new URL
("http://localhost:7001/web-services/JMSTestService?WSDL");

QName serviceName	= new QName("web-services");

	// create service
Service service = 
	factory.createService(wsdlURL, serviceName);
	
QName portName		= new QName("web-servicesPort");
QName operationName = new QName("submit");
